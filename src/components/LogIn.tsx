  ...
  return (
    <div className="login-container">
      ...
      <div className="login-inputs">
        ...
        <div
          className="form-group login-input has-danger"
        ...
        <div
          className="btn-group login-btn-group"
          role="group"
        ...
        >
          <input
            ...
            id="btnradio1"
            autoComplete="off"
            onChange={() => setAccountType(ACCOUNT_TYPE_ATHLETE)}
            checked={accountType === ACCOUNT_TYPE_ATHLETE}
          />
          ...
          <input
            ...
            id="btnradio2"
            autoComplete="off"
            onChange={() => setAccountType(ACCOUNT_TYPE_MANAGER)}
            checked={accountType === ACCOUNT_TYPE_MANAGER}
          />
      ...
      <div className="login-submit-container">
        <button
          className="login-submit btn btn-lg btn-primary"
          type="button"
          onClick={() => logIn()}
        >
          Log In
